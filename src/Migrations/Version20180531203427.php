 ...
 */
final class Version20180531203427 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, bedroom_id INT DEFAULT NULL, user_id INT DEFAULT NULL, start_date DATE NOT NULL, final_date DATE NOT NULL, INDEX IDX_42C84955BDB6797C (bedroom_id), INDEX IDX_42C84955A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
